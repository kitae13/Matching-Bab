...
public class MatchController {
    ...
    @PatchMapping(
            "/requests/{matchRequestId}/accept"
    )
    public ApiResponse<MatchAcceptResponse>
    acceptRequest(
            @PathVariable
            @Positive(
                    message = "밥약 신청 ID는 양수여야 합니다."
            )
            Long matchRequestId
    ) {
        return ApiResponse.success(
                "밥약 신청을 수락했습니다.",
                matchRequestService.acceptRequest(
                        matchRequestId
                )
        );
    }
    ...
    @PatchMapping(
            "/requests/{matchRequestId}/reject"
    )
    public ApiResponse<MatchRequestStatusResponse>
    rejectRequest(
            @PathVariable
            @Positive(
                    message = "밥약 신청 ID는 양수여야 합니다."
        ...
        return ApiResponse.success(
                "밥약 신청을 거절했습니다.",
                matchRequestService.rejectRequest(
                        matchRequestId
                )
        );
    }
    ...
    @PatchMapping(
            "/requests/{matchRequestId}/cancel"
    )
    public ApiResponse<MatchRequestStatusResponse>
    cancelRequest(
            @PathVariable
